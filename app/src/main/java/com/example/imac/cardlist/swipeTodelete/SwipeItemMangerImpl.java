 ...
 */
public class SwipeItemMangerImpl implements SwipeAdapterInterface.SwipeItemMangerInterface {

    private RecyclerSwipeAdapter.Mode mode = RecyclerSwipeAdapter.Mode.Single;
    ...
    public RecyclerSwipeAdapter.Mode getMode() {
        return mode;
    }

    public void setMode(RecyclerSwipeAdapter.Mode mode) {
        this.mode = mode;
    ...
    public void openItem(int position) {
        if (mode == RecyclerSwipeAdapter.Mode.Multiple) {
    ...
    class SwipeMemory extends SimpleSwipeListener {
        ...
        public void onStartOpen(SwipeLayout layout) {
            if (mode == RecyclerSwipeAdapter.Mode.Single) {
