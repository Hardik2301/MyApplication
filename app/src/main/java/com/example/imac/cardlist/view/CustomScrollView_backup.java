...
public class CustomScrollView_backup extends HorizontalScrollView {
    ...
    public CustomScrollView_backup(Context context) {
        super(context,null);
    }

    public CustomScrollView_backup(Context context, AttributeSet attrs) {
